...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_CzWdd1_H.mjs'
    ).then(n => n.Z).catch((e) => {
...
}, "/home/user/mi-repo/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/user/mi-repo/node_modules/astro/components/Picture.astro", void 0);
