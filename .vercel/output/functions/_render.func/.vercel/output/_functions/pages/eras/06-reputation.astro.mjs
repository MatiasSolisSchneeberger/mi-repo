...
const $$06Reputation = createComponent(($$result, $$props, $$slots) => {
  const erasArreglo = [
    "debut",
    "fearless",
    "speakNow",
...
Set list
      ...
      "px-2 py-2 w-full gap-2 rounded-xl items-center justify-center self-center shrink-0 relative overflow-hidden",
      estado === "No Cantadoo" ? "flex flex-row" : "hidden",
      {
        "bg-debut-600": era === "debut",
        "bg-fearless-600": era === "fearless",
        "bg-speakNow-600": era === "speakNow",
...
}, "/home/user/mi-repo/src/pages/eras/06-reputation.astro", void 0);

const $$file = "/home/user/mi-repo/src/pages/eras/06-reputation.astro";
const $$url = "/swifties-eras-tour/eras/06-reputation";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
	__proto__: null,
	default: $$06Reputation,
	file: $$file,
	url: $$url
