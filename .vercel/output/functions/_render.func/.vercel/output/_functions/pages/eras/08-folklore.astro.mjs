...
const $$08Folklore = createComponent(($$result, $$props, $$slots) => {
  const erasArreglo = [
    "debut",
    "fearless",
    "speakNow",
...
}, "/home/user/mi-repo/src/pages/eras/08-folklore.astro", void 0);

const $$file = "/home/user/mi-repo/src/pages/eras/08-folklore.astro";
const $$url = "/swifties-eras-tour/eras/08-folklore";
