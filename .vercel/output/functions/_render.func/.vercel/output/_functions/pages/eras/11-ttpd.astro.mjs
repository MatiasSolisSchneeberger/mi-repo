...
const $$11TTPD = createComponent(($$result, $$props, $$slots) => {
  const erasArreglo = [
    "debut",
    "fearless",
    "speakNow",
...
Dia ${tipo} </p> </div> <div class="px-2 py-2.5 flex flex-col gap-2 items-start justify-center self-stretch flex-1 relative"> <div class="flex flex-row gap-2.5 items-center justify-start shrink-0 relative"> ${renderComponent($$result2, "CalendarSVG", $$CalendarSVG, { "era": era })} <p${addAttribute([
        ...
        ], "class:list")}> ${renderComponent($$result2, "MusicSVG", $$MusicSVG, { "era": era })} <a${addAttribute(`swifties-eras-tour/eras/12-mashup`, "href")}${addAttribute([
...
Mashup con: ${mashupCon} </a> </div> </div> </div>`;
      }
    )} </div>`;
...
}, "/home/user/mi-repo/src/pages/eras/11-TTPD.astro", void 0);

const $$file = "/home/user/mi-repo/src/pages/eras/11-TTPD.astro";
const $$url = "/swifties-eras-tour/eras/11-TTPD";
