const eras = [
	{
		albums: "debut",
		logo: "/swifties-eras-tour/images/Logos-Discos/01-Logo-Debut.png",
		foto: "/swifties-eras-tour/images/Fotos/01-TaylorSwift.png",
		portada: "/swifties-eras-tour/images/Portadas-Discos/.png",
		emojie: "/swifties-eras-tour/images/Emojis/01.taylorSwift.png",
		linkPage: "/swifties-eras-tour/eras/01-debut",
		...
		anterior: "/swifties-eras-tour/eras/12-mashup",
		siguiente: "/swifties-eras-tour/eras/02-fearless",
		canciones: [
			{
				title: "Tim McGraw",
				estado: "Cantado",
				...
				info: [
					{
						...
						mashupCon: null,
						instrumento: "Guitarra",
						lugar: "Río de Janeiro, Brasilasil"
					}
				],
				etiquetas: {
					principal: "guitarra",
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "So High School y Everything Has Changed",
						instrumento: "Piano",
	...
	{
		albums: "fearless",
		logo: "/swifties-eras-tour/images/Logos-Discos/02-Logo-Fearless.png",
		foto: "/swifties-eras-tour/images/Fotos/02-Fearless.png",
		portada: "/swifties-eras-tour/images/Portadas-Discos/02-Portada-Fearless.png",
		emojie: "public/images/Emojis/02.fearless.png",
		linkPage: "/swifties-eras-tour/eras/02-fearless",
		...
		anterior: "/swifties-eras-tour/eras/01-debut",
		siguiente: "/swifties-eras-tour/eras/03-speakNow",
		canciones: [
			{
				title: "Fearless",
				estado: "Setlist",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "You're On Your Own, Kid",
						instrumento: "Piano",
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Come Back...Be Here y The Other Side of the Door",
						instrumento: "Guitarra",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Getaway Car y August",
						instrumento: "Guitarra",
						lugar: "Atlanta, EE UU"
					},
					{
						...
						cantSorp: null,
						mashupCon: "Come Back...Be Here y The Way I Loved You",
						instrumento: "Guitarra",
						lugar: "Lisboa, Portugal"
					}
				],
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "All Of The Girls You Loved Before",
						instrumento: "Piano",
	...
	{
		albums: "speakNow",
		logo: "/swifties-eras-tour/images/Logos-Discos/03-Logo-SpeakNow.png",
		foto: "/swifties-eras-tour/images/Fotos/03-SpeakNow.png",
		portada: "",
		emojie: "public/images/Emojis/03.speakNow.png",
		linkPage: "/swifties-eras-tour/eras/03-speakNow",
		...
		anterior: "/swifties-eras-tour/eras/02-fearless",
		siguiente: "/swifties-eras-tour/eras/04-red",
		canciones: [
			{
				title: "Mine",
				estado: "Cantado",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "I Can Fix Him (No Really I Can)",
						instrumento: "Guitarra",
						lugar: "Madrid, España"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Sad Beautiful Tragic",
						instrumento: "Guitarra",
						lugar: "Londres, Inglaterra"
					}
				],
		...
		notas: [
			{
				nota: "* Castles Crumbling: el interludio entre el set de Red y Speak Now contiene partes de esta canción, junto con Enchanted"
			},
			{
				nota: "* Long Live: fue agregado en 7 de Julio (el mismo dia que salió Speak Now Taylor's Version) en Kansas City al setlist. Y fue retirado el 9 de mayo al agregar TTPD"
			},
			{
				nota: "El 7 de Julio del 2023 fue la premier del videoclip 'I Can See You'"
			},
			{
				nota: "El 5 de Mayo del 2023 fue anunciado Speak Now (Taylor's Version)"
			}
		]
	},
	{
		albums: "red",
		logo: "/swifties-eras-tour/images/Logos-Discos/04-Logo-Red.png",
		foto: "/swifties-eras-tour/images/Fotos/04-Red.png",
		portada: "",
		emojie: "public/images/Emojis/04.red.png",
		linkPage: "/swifties-eras-tour/eras/04-red",
		...
		anterior: "/swifties-eras-tour/eras/03-speakNow",
		siguiente: "/swifties-eras-tour/eras/05-1989",
		canciones: [
			{
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Teardrops On My Guitar",
						instrumento: "Guitarra",
						lugar: "Pittsburgh, EE UU"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Sweeter Than Fiction",
						instrumento: "Guitarra",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Mary's Song (Oh My My My) y So High School",
						instrumento: "Piano",
						lugar: "Ámsterdam, Países Bajos"
					},
					{
						...
						cantSorp: "Ed Sheeran",
						mashupCon: "End Game y Thinking Out Loud (de Ed Sheeran)",
						instrumento: "Guitarra",
						lugar: "Ámsterdam, Países Bajos"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "The Way I Loved You y The Other Side of the Door",
						instrumento: "Guitarra",
						lugar: "Melbourne, Australia"
					},
					{
						...
						cantSorp: null,
						mashupCon: "The Black Dog y Maroon",
						instrumento: "Piano",
						lugar: "Londres, Inglaterra"
					}
				],
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Death By A Thousand Cuts",
						instrumento: "Guitarra",
						lugar: "Singapur, Singapur"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "How You Get The Girl y New Romantics",
						instrumento: "Guitarra",
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "The Last Great American Dynasty",
						instrumento: "Guitarra",
						lugar: "Hamburgo, Alemania"
					}
				],
	...
	{
		albums: "1989",
		logo: "/swifties-eras-tour/images/Logos-Discos/05-Logo-1989.png",
		foto: "/swifties-eras-tour/images/Fotos/05-1989.png",
		portada: "",
		emojie: "public/images/Emojis/05.1989.png",
		linkPage: "/swifties-eras-tour/eras/05-1989",
		...
		anterior: "/swifties-eras-tour/eras/04-red",
		siguiente: "/swifties-eras-tour/eras/06-reputation",
		canciones: [
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Say Don't Go y Clean",
						instrumento: "Piano",
						lugar: "Estocolmo, Suecia"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Is It Over Now? y Clean",
						instrumento: "Piano",
						lugar: "Londres, Inglaterra"
					},
					{
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Right Where You Left Me",
						instrumento: "Guitarra",
						lugar: "Zúrich, Suiza"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Message In A Bottle y New Romantics",
						instrumento: "Guitarra",
						lugar: "Estocolmo, Suecia"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Call It What You Want",
						instrumento: "Piano",
						lugar: "Singapur, Singapur"
					},
					{
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Would've, Could've, Should've",
						instrumento: "Guitarra",
						lugar: "Edimburgo, Escocia"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Say Don't Go y Welcome To New York",
						instrumento: "Piano",
						lugar: "Estocolmo, Suecia"
					},
					{
						...
						cantSorp: null,
						mashupCon: "Out of the Woods y Is It Over Now?",
						instrumento: "Piano",
						lugar: "Londres, Inglaterra"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Fresh Out The Slammer",
						instrumento: "Guitarra",
						lugar: "Munich, Alemania"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Message In A Bottle y How You Get The Girl",
						instrumento: "Guitarra",
						lugar: "Estocolmo, Suecia"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Welcome To New York y Clean",
						instrumento: "Piano",
						lugar: "Estocolmo, Suecia"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "The Tortured Poets Department",
						instrumento: "Guitarra",
						lugar: "Lisboa, Portugal"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Out of the Woods y Clean",
						instrumento: "Piano",
						lugar: "Londres, Inglaterra"
					}
				],
		...
		notas: [
			{
				nota: "El 9 de Agosto del 2023 fue anunciado 1989 (Taylor's Version)"
			}
		]
	},
	{
		albums: "reputation",
		logo: "/swifties-eras-tour/images/Logos-Discos/06-Logo-Reputation.png",
		foto: "/swifties-eras-tour/images/Fotos/06-Reputation.png",
		portada: "",
		emojie: "public/images/Emojis/06.reputation.png",
		linkPage: "/swifties-eras-tour/eras/06-reputation",
		...
		anterior: "/swifties-eras-tour/eras/05-1989",
		siguiente: "/swifties-eras-tour/eras/07-lover",
		canciones: [
			{
				title: "...Ready For It?",
				estado: "Setlist",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "August y The Other Side of the Door",
						instrumento: "Guitarra",
						lugar: "Melbourne, Australia"
					},
					{
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "I Don't Wanna Live Forever",
						instrumento: "Piano",
						lugar: "Singapur, Singapur"
					},
					{
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "I Forgot That You Existed",
						instrumento: "Guitarra",
						lugar: "Cardiff, Gales"
					}
				],
	...
	{
		albums: "lover",
		logo: "/swifties-eras-tour/images/Logos-Discos/07-Logo-Lover.png",
		foto: "/swifties-eras-tour/images/Fotos/07-Lover.png",
		portada: "",
		emojie: "public/images/Emojis/07.lover.png",
		linkPage: "/swifties-eras-tour/eras/07-lover",
		...
		anterior: "/swifties-eras-tour/eras/06-reputation",
		siguiente: "/swifties-eras-tour/eras/08-folklore",
		canciones: [
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "This Is Why We Can't Have Nice Things",
						instrumento: "Guitarra",
						lugar: "Cardiff, Gales"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "Today Was A Fairytale",
						instrumento: "Guitarra",
						lugar: "Varsovia, Polonia"
					}
				],
	...
	{
		albums: "folklore",
		logo: "/swifties-eras-tour/images/Logos-Discos/08-Logo-Folklore.png",
		foto: "/swifties-eras-tour/images/Fotos/08-Folklore.png",
		portada: "",
		emojie: "public/images/Emojis/08.folklore.png",
		linkPage: "/swifties-eras-tour/eras/08-folklore",
		...
		anterior: "/swifties-eras-tour/eras/07-lover",
		siguiente: "/swifties-eras-tour/eras/09-evermore",
		canciones: [
			{
				title: "the 1 *",
				estado: "Setlist",
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Getaway Car y The Other Side of the Door",
						instrumento: "Guitarra",
						lugar: "Melbourne, Australia"
					}
				],
	...
	{
		albums: "evermore",
		logo: "/swifties-eras-tour/images/Logos-Discos/09-Logo-Evermore.png",
		foto: "/swifties-eras-tour/images/Fotos/09-Evermore.png",
		portada: "",
		emojie: "public/images/Emojis/09.evermore.png",
		linkPage: "/swifties-eras-tour/eras/09-evermore",
		...
		anterior: "/swifties-eras-tour/eras/08-folklore",
		siguiente: "/swifties-eras-tour/eras/10-midnights",
		canciones: [
			{
				title: "willow",
				estado: "Setlist",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "This Is What You Came For",
						instrumento: "Guitarra",
						lugar: "Liverpool, Inglaterra"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "It's Nice To Have A Friend",
						instrumento: "Guitarra",
						lugar: "Edimburgo, Escocia"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "My Boy Only Breaks His Favourite Toys",
						instrumento: "Piano",
						lugar: "Sídney, Australia"
					}
				],
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "A Perfectly Good Heart",
						instrumento: "Guitarra",
						lugar: "Zúrich, Suiza"
					}
				],
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "All You Had To Do Was Stay",
						instrumento: "Guitarra",
						lugar: "Zúrich, Suiza"
					}
				],
	...
	{
		albums: "midnights",
		logo: "/swifties-eras-tour/images/Logos-Discos/10-Logo-Midnights.png",
		foto: "/swifties-eras-tour/images/Fotos/10-Midnights.png",
		portada: "",
		emojie: "public/images/Emojis/10.midnights.png",
		linkPage: "/swifties-eras-tour/eras/10-midnights",
		...
		anterior: "/swifties-eras-tour/eras/09-evermore",
		siguiente: "/swifties-eras-tour/eras/11-TTPD",
		canciones: [
			{
				title: "Lavander Haze",
				estado: "Setlist",
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "The Black Dog y Come Back...Be Here",
						instrumento: "Piano",
						lugar: "Londres, Inglaterra"
					},
					{
			...
			},
			{
				...
				info: [
					...
					},
					{
						...
						cantSorp: null,
						mashupCon: "I Look In People's Windows",
						instrumento: "Piano",
						lugar: "Madrid, España"
					}
				],
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Everything Has Changed",
						instrumento: "Guitarra",
						lugar: "Lyon, Francia"
					}
				],
		...
		notas: [
			{
				nota: "El 26 de mayo del 2023 Taylor anunció y mostró el video musical de Karma."
			},
			{
				nota: "Desde el 26 hasta el 28 de mayo del 2023 Ice Spice cantó 'Karma' junto con Taylor"
			},
			{
				nota: "Taylor cambia la letra de Karma, de \"Karma is the guy on the screem\" a \"Karma is the guy on the Chiefs\", al estar presente Travis"
			}
		]
	},
	{
		albums: "TTPD",
		logo: "/swifties-eras-tour/images/Logos-Discos/11-Logo-TTPD.png",
		foto: "/swifties-eras-tour/images/Fotos/11-TTPD.png",
		portada: "",
		emojie: "/swifties-eras-tour/images/Emojis/11.TTPD.png",
		linkPage: "/swifties-eras-tour/eras/11-TTPD",
		...
		anterior: "/swifties-eras-tour/eras/10-midnights",
		siguiente: "/swifties-eras-tour/eras/12-mashup",
		canciones: [
			{
				title: "Fortnight",
				estado: "Setlist",
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Now That We Don't Talk",
						instrumento: "Guitarra",
						lugar: "Lisboa, Portugal"
					}
				],
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Come Back...Be Here y Maroon",
						instrumento: "Piano",
						lugar: "Londres, Inglaterra"
					},
					{
				...
				info: [
					{
						...
						cantSorp: null,
						mashupCon: "Dancing With Our Hands Tied",
						instrumento: "Guitarra",
						lugar: "Dublín, Irlanda"
					}
				],
				...
				info: [
					{
						...
						cantSorp: "Gracie Abrams",
						mashupCon: null,
						instrumento: "Guitarra (Taylor) y Piano (Gracie) ",
						lugar: "Londres, Inglaterra"
					}
				],
				etiquetas: {
		...
		notas: [
			{
				nota: "TTPD fue agregado al setlist en la primera noche de Paris, Francia el 9 de Mayo."
			},
			{
				nota: "* us.: colaboración con Gracie Abrams, en el disco The Secret of Us"
			}
		]
	},
	{
		albums: "mashup",
		logo: "/swifties-eras-tour/images/Logos-Discos/12-Logo-Mashups.png",
		foto: "/swifties-eras-tour/images/Fotos/12-Mashup.png",
		portada: "",
		emojie: "/swifties-eras-tour/images/Emojis/12.MashUp.png",
		linkPage: "/swifties-eras-tour/eras/12-mashup",
		Spotify: "",
		YTMusic: "",
		anterior: "/swifties-eras-tour/eras/11-TTPD",
		siguiente: "/swifties-eras-tour/eras/01-debut",
		canciones: [
			{
