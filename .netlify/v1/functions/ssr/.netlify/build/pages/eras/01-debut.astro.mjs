...
const $$01Debut = createComponent(($$result, $$props, $$slots) => {
  const era = "debut";
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/01-debut.astro", void 0);

const $$file = "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/01-debut.astro";
const $$url = "/mi-repo/eras/01-debut";
