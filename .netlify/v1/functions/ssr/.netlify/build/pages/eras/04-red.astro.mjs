...
const $$04Red = createComponent(($$result, $$props, $$slots) => {
  const era = "red";
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/04-red.astro", void 0);

const $$file = "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/04-red.astro";
const $$url = "/mi-repo/eras/04-red";
