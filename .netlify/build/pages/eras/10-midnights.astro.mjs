...
const $$10Midnights = createComponent(($$result, $$props, $$slots) => {
  const era = "midnights";
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/10-midnights.astro", void 0);

const $$file = "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/10-midnights.astro";
const $$url = "/mi-repo/eras/10-midnights";
