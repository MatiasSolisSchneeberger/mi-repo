...
const $$03SpeakNow = createComponent(($$result, $$props, $$slots) => {
  const era = "speakNow";
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/03-speakNow.astro", void 0);

const $$file = "D:/Matias/Facultad/Programacion/prueba2/src/pages/eras/03-speakNow.astro";
const $$url = "/mi-repo/eras/03-speakNow";
