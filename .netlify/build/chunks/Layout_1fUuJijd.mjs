import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, e as renderSlot, d as renderComponent, g as renderHead } from './astro/server_DnNbMkkd.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
/* empty css                            */
...
const $$ButtonPrimario = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")}${addAttribute([
    "rounded-[100px] flex flex-col gap-2 items-center justify-center shrink-0 h-10 relative overflow-hidden",
    {
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/ButtonPrimario.astro", void 0);
...
}, "D:/Matias/Facultad/Programacion/prueba2/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header${addAttribute([
    "z-10 py-4 flex flex-col sm:flex-row gap-2.5 items-center self-stretch shrink-0 h-auto w-full justify-center sm:justify-between px-10 ",
    {
      "bg-debut-900": era === "debut",
      "bg-fearless-900": era === "fearless",
      "bg-speakNow-900": era === "speakNow",
      "bg-red-900": era === "red",
      "bg-1989-900": era === "1989",
      "bg-reputation-900": era === "reputation",
      "bg-lover-900": era === "lover",
      "bg-folklore-900": era === "folklore",
      "bg-evermore-900": era === "evermore",
      "bg-midnights-900": era === "midnights",
      "bg-TTPD-900": era === "TTPD",
      "bg-mashup-900": era === "mashup"
    }
  ], "class:list")}> ${renderComponent($$result, "Logo", $$Logo, { "era": era })} <nav class="flex flex-row gap-2.5 items-center justify-center shrink-0 relative"> ${renderComponent($$result, "ButtonPrimario", $$ButtonPrimario, { "era": era, "href": "/mi-repo/outfits", "icono": null }, { "default": ($$result2) => renderTemplate`
Outfits
` })} ${renderComponent($$result, "ButtonPrimario", $$ButtonPrimario, { "era": era, "href": "/mi-repo/#Canciones", "icono": null }, { "default": ($$result2) => renderTemplate`
Canciones
` })} ${renderComponent($$result, "ButtonPrimario", $$ButtonPrimario, { "era": era, "href": "/mi-repo/#Conciertos", "icono": null }, { "default": ($$result2) => renderTemplate`
Conciertos
` })} </nav> </header>`;
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/Header.astro", void 0);
...
const $$GitHubSvg = createComponent(($$result, $$props, $$slots) => {
  ...
  const { era } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="shrink-0 relative overflow-visible"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"${addAttribute(`fill-${era}-100`, "class")} class="icon icon-tabler icons-tabler-filled icon-tabler-brand-github"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M5.315 2.1c.791 -.113 1.9 .145 3.333 .966l.272 .161l.16 .1l.397 -.083a13.3 13.3 0 0 1 4.59 -.08l.456 .08l.396 .083l.161 -.1c1.385 -.84 2.487 -1.17 3.322 -1.148l.164 .008l.147 .017l.076 .014l.05 .011l.144 .047a1 1 0 0 1 .53 .514a5.2 5.2 0 0 1 .397 2.91l-.047 .267l-.046 .196l.123 .163c.574 .795 .93 1.728 1.03 2.707l.023 .295l.007 .272c0 3.855 -1.659 5.883 -4.644 6.68l-.245 .061l-.132 .029l.014 .161l.008 .157l.004 .365l-.002 .213l-.003 3.834a1 1 0 0 1 -.883 .993l-.117 .007h-6a1 1 0 0 1 -.993 -.883l-.007 -.117v-.734c-1.818 .26 -3.03 -.424 -4.11 -1.878l-.535 -.766c-.28 -.396 -.455 -.579 -.589 -.644l-.048 -.019a1 1 0 0 1 .564 -1.918c.642 .188 1.074 .568 1.57 1.239l.538 .769c.76 1.079 1.36 1.459 2.609 1.191l.001 -.678l-.018 -.168a5.03 5.03 0 0 1 -.021 -.824l.017 -.185l.019 -.12l-.108 -.024c-2.976 -.71 -4.703 -2.573 -4.875 -6.139l-.01 -.31l-.004 -.292a5.6 5.6 0 0 1 .908 -3.051l.152 -.222l.122 -.163l-.045 -.196a5.2 5.2 0 0 1 .145 -2.642l.1 -.282l.106 -.253a1 1 0 0 1 .529 -.514l.144 -.047l.154 -.03z"></path> </svg> </div>`;
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/svg/GitHubSvg.astro", void 0);
...
const $$GitHubBordeSvg = createComponent(($$result, $$props, $$slots) => {
  ...
  const { era } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="shrink-0 relative overflow-visible"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"${addAttribute(`stroke-${era}-100`, "class")} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-brand-github"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path> </svg> </div>`;
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/svg/GitHubBordeSvg.astro", void 0);
...
const $$PortfolioSvg = createComponent(($$result, $$props, $$slots) => {
  ...
  const { era } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="shrink-0 relative overflow-visible"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"${addAttribute(`stroke-${era}-100`, "class")} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-briefcase"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M3 7m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z"></path> <path d="M8 7v-2a2 2 0 0 1 2 -2h4a2 2 0 0 1 2 2v2"></path> <path d="M12 12l0 .01"></path><path d="M3 13a20 20 0 0 0 18 0"></path> </svg> </div>`;
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/svg/PortfolioSvg.astro", void 0);
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/svg/LinkedInSvg.astro", void 0);
...
const $$MailSvg = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$MailSvg;
  const { era } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="shrink-0 relative overflow-visible"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"${addAttribute(`stroke-${era}-100`, "class")} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-mail"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"></path> <path d="M3 7l9 6l9 -6"></path> </svg> </div>`;
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/svg/MailSvg.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer${addAttribute([
    ...
    {
      "bg-debut-900 text-debut-200": era === "debut",
      "bg-fearless-900 text-fearless-200": era === "fearless",
      "bg-speakNow-900 text-speakNow-200": era === "speakNow",
      "bg-red-900 text-red-200": era === "red",
      "bg-1989-900 text-1989-200": era === "1989",
      "bg-reputation-900 text-reputation-200": era === "reputation",
      "bg-lover-900 text-lover-200": era === "lover",
      "bg-folklore-900 text-folklore-200": era === "folklore",
      "bg-evermore-900 text-evermore-200": era === "evermore",
      "bg-midnights-900 text-midnights-200": era === "midnights",
      "bg-TTPD-900 text-TTPD-200": era === "TTPD",
      "bg-mashup-900 text-mashup-200": era === "mashup"
    }
...
<br> <br>
Soy una apasionado swiftie y he creado este sitio web como un tributo a Taylor Swift y su increíble carrera. Este sitio es la primera página que hago en su totalidad, y busca celebrar cada momento y cada canción. Agradezco a Taylor por ser una inspiración constante y por su música que me ha acompañado a lo largo de los años.
<br> <br>
...
Eras
</h3> <div class=" flex flex-col gap-2 w-max"> <a href="/mi-repo/01-debut" class="text-body-large">Taylor Swift</a> <a href="/mi-repo/02-fearless" class="text-body-large">Fearless</a> <a href="/mi-repo/03-speakNow" class="text-body-large">Speak Now</a> <a href="/mi-repo/04-red" class="text-body-large">Red</a> <a href="/mi-repo/05-1989" class="text-body-large">1989</a> <a href="/mi-repo/06-reputation" class="text-body-large">Reputation</a> <a href="/mi-repo/07-lover" class="text-body-large">Lover</a> <a href="/mi-repo/08-folklore" class="text-body-large">Folklore</a> <a href="/mi-repo/09-evermore" class="text-body-large">Evermore</a> <a href="/mi-repo/10-midnights" class="text-body-large">Midnights</a> <a href="/mi-repo/11-TTPD" class="text-body-large">TTPD</a> <a href="/mi-repo/12-mashup" class="text-body-large">Mashup</a> </div> </article> <article class="flex flex-col gap-4 w-full"> <h3 class=" text-start text-title-large">
Contacto
...
}, "D:/Matias/Facultad/Programacion/prueba2/src/components/Footer.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width = device-width"><link rel="icon" type="image/svg+xml" href="/mi-repo/components/svg/iconoPagina.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Tipografías --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family = Rubik:ital,wght@0,300..900;1,300..900&display = swap" rel="stylesheet"><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body${addAttribute([
    "no-scrollbar w-full",
    {
      "bg-debut-50": era === "debut",
      "bg-fearless-50": era === "fearless",
      "bg-speakNow-50": era === "speakNow",
      "bg-red-50": era === "red",
      "bg-1989-50": era === "1989",
      "bg-reputation-50": era === "reputation",
      "bg-lover-50": era === "lover",
      "bg-folklore-50": era === "folklore",
      "bg-evermore-50": era === "evermore",
      "bg-midnights-50": era === "midnights",
      "bg-TTPD-50": era === "TTPD",
      "bg-mashup-50": era === "mashup"
    }
  ], "class:list")}> ${renderComponent($$result, "Header", $$Header, { "era": era })} <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, { "era": era })} </body></html>`;
}, "D:/Matias/Facultad/Programacion/prueba2/src/layouts/Layout.astro", void 0);

export { $$ButtonPrimario as $, $$Layout as a };
